...
ED {
    ...
    T.position(0.0, 2.15, -10.2).scale(8.8, 3.6, 0.24) {
        R.cube() { C.rgba(0.11, 0.10, 0.14, 1.0) }
    }

    T.position(-5.0, 0.35, -1.2).scale(0.55, 0.55, 0.55) {
        R.cube() { C.rgba(0.70, 0.66, 0.60, 1.0) }
    }
    T.position(-4.35, 0.35, -1.2).scale(0.55, 0.55, 0.55) {
        R.cube() { C.rgba(0.62, 0.68, 0.72, 1.0) }
    }
    T.position(-3.70, 0.35, -1.2).scale(0.55, 0.55, 0.55) {
        R.cube() { C.rgba(0.74, 0.70, 0.64, 1.0) }
    }
    T.position(-4.35, 0.95, -1.2).scale(0.48, 0.48, 0.48) {
        R.cube() { C.rgba(0.80, 0.76, 0.70, 1.0) }
    }

    T.position(4.10, 0.35, -0.85).scale(0.52, 0.52, 0.52) {
        R.cube() { C.rgba(0.64, 0.69, 0.78, 1.0) }
    }
    T.position(4.75, 0.35, -0.85).scale(0.52, 0.52, 0.52) {
        R.cube() { C.rgba(0.76, 0.72, 0.68, 1.0) }
    }
    T.position(5.40, 0.35, -0.85).scale(0.52, 0.52, 0.52) {
        R.cube() { C.rgba(0.66, 0.74, 0.70, 1.0) }
    }
    T.position(4.75, 0.92, -0.85).scale(0.44, 0.44, 0.44) {
        R.cube() { C.rgba(0.84, 0.80, 0.74, 1.0) }
    }
    T.position(5.40, 0.92, -0.85).scale(0.44, 0.44, 0.44) {
        R.cube() { C.rgba(0.74, 0.80, 0.76, 1.0) }
    }

    T.position(-0.95, 0.35, 3.15).scale(0.50, 0.50, 0.50) {
        R.cube() { C.rgba(0.72, 0.68, 0.62, 1.0) }
    }
    T.position(-0.30, 0.35, 3.15).scale(0.50, 0.50, 0.50) {
        R.cube() { C.rgba(0.62, 0.69, 0.75, 1.0) }
    }
    T.position(0.35, 0.35, 3.15).scale(0.50, 0.50, 0.50) {
        R.cube() { C.rgba(0.76, 0.73, 0.68, 1.0) }
    }
    T.position(-0.30, 0.90, 3.15).scale(0.42, 0.42, 0.42) {
        R.cube() { C.rgba(0.82, 0.79, 0.74, 1.0) }
    }

    T.position(-3.2, 0.55, -9.85).scale(0.42, 0.42, 0.42) {
        R.cube() { C.rgba(1.00, 0.22, 0.28, 1.0) EM.on() }
    }
    T.position(-1.9, 0.95, -9.85).scale(0.42, 0.42, 0.42) {
        R.cube() { C.rgba(1.00, 0.58, 0.12, 1.0) EM.on() }
    }
    T.position(-0.6, 1.35, -9.85).scale(0.42, 0.42, 0.42) {
        R.cube() { C.rgba(1.00, 0.88, 0.20, 1.0) EM.on() }
    }
    T.position(0.7, 1.75, -9.85).scale(0.42, 0.42, 0.42) {
        R.cube() { C.rgba(0.26, 1.00, 0.40, 1.0) EM.on() }
    }
    T.position(2.0, 2.15, -9.85).scale(0.42, 0.42, 0.42) {
        R.cube() { C.rgba(0.18, 0.68, 1.00, 1.0) EM.on() }
    }
    T.position(3.3, 2.55, -9.85).scale(0.42, 0.42, 0.42) {
        R.cube() { C.rgba(0.90, 0.26, 1.00, 1.0) EM.on() }
    }

    T.position(-3.2, 2.60, -9.55).scale(0.32, 0.32, 0.32) {
        R.cube() { C.rgba(1.00, 0.28, 0.36, 1.0) EM.on() }
    }
    T.position(-1.9, 2.20, -9.55).scale(0.32, 0.32, 0.32) {
        R.cube() { C.rgba(1.00, 0.66, 0.18, 1.0) EM.on() }
    }
    T.position(-0.6, 1.80, -9.55).scale(0.32, 0.32, 0.32) {
        R.cube() { C.rgba(1.00, 0.92, 0.28, 1.0) EM.on() }
    }
    T.position(0.7, 1.40, -9.55).scale(0.32, 0.32, 0.32) {
        R.cube() { C.rgba(0.34, 1.00, 0.46, 1.0) EM.on() }
    }
    T.position(2.0, 1.00, -9.55).scale(0.32, 0.32, 0.32) {
        R.cube() { C.rgba(0.28, 0.76, 1.00, 1.0) EM.on() }
    }
    T.position(3.3, 0.60, -9.55).scale(0.32, 0.32, 0.32) {
