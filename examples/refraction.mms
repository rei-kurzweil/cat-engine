...
refraction_panel("ior_1_10", [-1.9,  1.9, 0.0], [0.62, 0.88, 1.00, 1.0], 1.10, 0.05)
refraction_panel("ior_1_33", [ 1.9,  1.9, 0.0], [0.72, 1.00, 0.88, 1.0], 1.33, 0.10)
refraction_panel("ior_1_50", [-1.9, -1.9, 0.0], [0.94, 0.72, 1.00, 1.0], 1.50, 0.16)
refraction_panel("ior_1_80", [ 1.9, -1.9, 0.0], [1.00, 0.68, 0.78, 1.0], 1.80, 0.24)
