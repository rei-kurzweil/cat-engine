...
pub struct EditorContextState {
    ...
    pub cameras_visible: bool,
    pub collider_visibility: Option<crate::engine::ecs::system::CollisionVisualizationMode>,
    pub spring_bones_visible: bool,
...
impl Default for EditorContextState {
    fn default() -> Self {
        Self {
            ...
            collider_visibility: None,
            spring_bones_visible: false,
