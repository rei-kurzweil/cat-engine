...
layout(location = 13) in float i_transmission_roughness;
...
layout(location = 6) flat out float v_transmission_roughness;
...
void main() {
    ...
    v_transmission_roughness = i_transmission_roughness;
